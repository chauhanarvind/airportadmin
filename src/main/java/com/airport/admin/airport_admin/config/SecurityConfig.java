...
import com.airport.admin.airport_admin.security.JwtAuthenticationFilter;
import com.airport.admin.airport_admin.security.JwtTokenProvider;
import com.airport.admin.airport_admin.security.UserDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        provider.setPasswordEncoder(passwordEncoder()); // THIS IS REQUIRED
        return provider;
    }
    ...
    public AuthenticationManager authenticationManager() {
        return new ProviderManager(authenticationProvider()); // ← use your own
    }
